                ...
                <div class="card border-0 shadow mb-4 ">
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select  name="jobtype" id="jobtype" class="form-select">
                                    <option>Select a Job Nature</option>
                                    @if ($category->isNotEmpty())
                                          @foreach ($jobsTypes as $jobsType)
                                          <option {{ ($job->job_type_id == $jobsType->id) ? 'selected' : ''}} value="{{ $jobsType->id }}">{{ $jobsType->name }}</option>
                                          @endforeach
                                      @endif
                        ...
                        <div class="mb-4">
                            ...
                            {{-- <textarea class="form-control" name="experience" id="experience" cols="5" rows="5" placeholder="Qualifications"></textarea> --}}
