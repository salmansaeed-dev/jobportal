                                ...
                                <tbody class="border-0">
                                    ...
                                    <tr class="active">
                                        <td>
                                            ...
                                            <div class="info1">{{ $jobApplications->job->jobType->name }} . {{ $jobApplications->job->location }}</div>
                                        </td>
                                        <td>{{ $jobApplications->created_at->format('d-m-y') }}</td>
                                        {{-- <td> Applications</td> --}}
                                        <td>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{ route('jobDetails', $jobApplications->job_id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
                                                    {{-- <li><a class="dropdown-item" href="{{ route('account.editJob', $job->id) }}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li> --}}
                                                    <li><a class="dropdown-item" href="#" onclick="removeJob({{ $jobApplications->id }})"><i class="fa fa-trash" aria-hidden="true"></i> Remove</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
