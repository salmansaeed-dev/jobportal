                ...
                <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                    <select name="category" id="category" class="form-control">
                        ...
                        {{-- @if ($newcatagory->isNotEmpty())
                          ...
                          @foreach ($newcatagory as $catagory )
            ...
            @if ($catagory->isNotEmpty())
                 ...
                 <div class="col-lg-4 col-xl-3 col-md-6">
                    <div class="single_catagory">
                        <a href="{{ route('jobs').'?catagory='.$fetch->id }}"><h4 class="pb-2">{{ $fetch->name }}</h4></a>
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="{{ route('jobDetails', $feature->id) }}" class="btn btn-primary btn-lg">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
